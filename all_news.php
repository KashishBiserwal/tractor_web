...
j
  <!-- <script>
      ...
      $("#allNews").click(function(){
        console.log("All news called")
      });
      $("#tractorNews").click(function(){
        tn.style.display = 'block';
        aNews.style.display = 'none';
        agn.style.display = 'none';
        syn.style.display = 'none';
        console.log("tractor news called")
      });
    
      $("#agricultureNews").click(function(){
        agn.style.display = 'block';
        aNews.style.display = 'none';
        tn.style.display = 'none';
        syn.style.display = 'none';
        console.log("Agriculture news called")
      });
    
      $("#sarkariNews").click(function(){
