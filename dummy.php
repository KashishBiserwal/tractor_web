...
?> 
  ...
  <script src="<?php $baseUrl; ?>model/costemer_haatbzr.js" defer></script>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-7">
                    <div id="container" class="container mt-1 mb-3 ">
                                ...
                                <div class="step_sellused">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-outline mt-4">
                                            ...
                                            <textarea class="form-control" id="aboutharvest" name="aboutharvest" rows="3"></textarea>
                                        </div>
                                    </div>
                        ...
                        <form id="form-step-2" class=" mul_stp_frm  ps-4 pe-4 " style="display:none;" method="post" action="">
                            <div class="d-flex justify-content-center mb-3">
                                <div class="col-12 col-lg-5 col-md-5 col-sm-5">
                                    <div class="float-start">Harvest Info</div>
                                </div>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-6 col-lg-6 mt-4">
                                        <div class="form-outline">
                                            ...
                                            <input type="text" id="number1" name="phone" class=" data_search form-control input-group-sm" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-6 col-lg-6 mt-4">
                                        <div class="form-outline">
    ...
    $(document).ready(function () {
        ...
        $(".next-step").click(function () {
            ...
            if (nextStep.length > 0) {
                displayStep(parseInt(nextStep.attr("data-step")));
            }
        });
        $(".prev-step").click(function () {
            ...
            if (prevStep.length > 0) {
                displayStep(parseInt(prevStep.attr("data-step"))); 
            }
        });
    });
</script>
