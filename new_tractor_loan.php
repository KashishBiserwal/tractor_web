          ...
          <div class="col-12 col-sm-12 col-md-4 col-lg-4 mt-4">
            ...
            <div class="col-12">
              ...
              <div class="form-check form-check-inline ">
                <input class="form-check-input border border-dark" type="radio" id="inlineCheckbox1" name="x" value="option1">
                <label class="form-check-label text-dark" for="inlineCheckbox1">Yes</label>
              </div>
              <div class="form-check form-check-inline text-center">
                <input class="form-check-input border border-dark" type="radio" id="inlineCheckbox2" name="x" value="option2">
            ...
            <div class="d-grid col-8 mx-auto mb-3">
              <button type="submit" class="btn btn-success fw-bold" data-bs-toggle="modal" data-bs-target="#contactModal">Apply for Loan</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <tbody>
      ...
      <td>Personal Loan</td>
        ...
        <td>
          ...
          <a href="javascript:void(0)" class=" text-primary read-more text-decoration-none fw-bold float-end" data-toggle="collapse" data-target="#collapse1">Read More</a>
        </div>
      </div>
    </div>
...
<div class="container">
    <h4 class="mt-5 assured px-2 fw-bold">Loan Solutions Tailored for Your Agricultural Needs at Bharat Tractors </h4>
   <p class="px-2 mt-3">Empower your farming journey with the right financial support. At Bharat Tractors, we offer a variety of loan options to suit your specific requirements. Whether you are looking to invest in a new tractor, a used one, implements, or even a harvester, we have you covered. Explore our diverse range of loan offerings and take the first step towards achieving your agricultural goals.
</p>
​​​​​   <h6 class="assured px-1 fw-bold">New Tractor Loan: Transforming Agriculture</h6>
   <p class=" px-2">Unleash the potential of modern farming with our New Tractor Loans. We understand the significance of a reliable tractor in boosting agricultural productivity. Benefit from competitive interest rates and flexible repayment options, ensuring you don't compromise on your farming ambitions.<p>
   <h6 class=" assured fw-bold px-1 mt-5">Used Tractor Loan: Maximizing Value</h6>
   <p class="px-2">Looking to invest in a pre-owned tractor? Our Used Tractor Loans provide a financial bridge to make it happen. Enjoy hassle-free documentation and attractive interest rates, allowing you to bring home the tractor you need without financial stress.</p> 
   <h6 class="assured fw-bold px-1 mt-5">Implement Loan: Enhance Your Efficiency</h6>
<p class="px-2">Upgrade your farming equipment with our Implement Loans. From plows to harvesters, we've got you covered. Flexible repayment options and quick approvals make acquiring the necessary implements a seamless process.</p>

<h6 class="assured  fw-bold px-1 mt-5">New Harvester Loan: Harvesting Success</h6>

<p class="px-2">Invest in the latest harvesting technology with our New Harvester Loans. Avail yourself of attractive interest rates and financing options, ensuring you stay at the forefront of agricultural innovation.
</p> 

<h6 class="assured fw-bold px-1 mt-5">Old Harvester Loan: Sustaining Tradition</h6>
<p class="px-2">Preserve your traditional harvesting methods with our Old Harvester Loans. Enjoy cost-effective financing solutions that honor your farming heritage.
</p>

<h6 class="assured fw-bold px-1 mt-5">Loan Against Tractor: Unlock Your Tractor's Value</h6>
<p class="px-2">Harness the equity in your tractor with our Loan Against Tractor. Quick approvals and convenient repayment options provide you with the financial flexibility you need.</p>

<h6 class="assured fw-bold px-1 mt-5">Personal Loan: Flexible Financing for Your Needs</h6>
<p class="px-2">For miscellaneous agricultural expenses, our Personal Loans offer a versatile financing solution. Whether it's for farm improvements or unexpected costs, our personal loans are tailored to meet your unique needs.</p>

<h6 class="assured fw-bold px-1 mt-5">Why Choose Bharat Tractors for Your Agricultural Loans?</h6>
<p class=" px-2">Specialization in Agricultural Equipment: We understand the unique needs of farmers, specializing in tractors and related equipment.</p>
<p class=" px-2">Extensive Network: Our wide network of dealers, lenders, and financial institutions ensures you have access to the best loan options available.
</p>
<p class=" px-2">Tailored Solutions: We provide customized loan solutions based on your individual requirements, ensuring a perfect fit for your financial situation.</p>
<p class="px-2">Transparency: We believe in transparent communication, ensuring you fully understand the terms, interest rates, and fees associated with your loan.</p>
<p class="px-2">Online Accessibility: With our online services, the loan application and approval process becomes convenient and accessible, especially for those in remote areas.</p>
<p class="px-2">Take the first step towards securing your agricultural future. Explore our loan options today at Bharat Tractors and experience farming with financial confidence. Get in touch with us to start your loan application process.</p>
<p class="px-2">Protect Your Investment: While you're investing in your farm, don't forget to safeguard your equipment with our comprehensive Tractor Insurance. Learn more (link to insurance page).</p>
        ...
        <div class="container">
          <div class="lecture_heading text-center">
           ...
           <div class="mt-4 pb-5">
            <div class="accordion " id="accordionFlushExample">
              <div class="accordion-item  rounded-3">
                <h2 class="accordion-header " id="flush-headingOne">
                  <button class="accordion-button collapsed  text-primary fw-bold h4" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">Questions Related to New Tractor Loan</button>
                </h2>
                      ...
                      <ul>
                        <li>
                          <b>Que. Who can apply for a new tractor loan?</b>
                           <p>Ans. All cultivators and farmland owners are eligible to apply for a new tractor loan.</p>
                         </li>

                        <li><b>Que. How long is the repayment period, and what is the repayment rate for a new tractor loan?</b>
                     <p>Ans. The repayment period for a new tractor loan is typically 60 months (5 years), and the rate is decided based on the customer's repayment capacity.
                     </p>
                    </li>
                ...
                <p>Ans. Required documents include a filled application form, KYC documents, passport-sized photos, loan statements (if applicable), and land documents.</p>
                <li>
               </ul>
               </p>
                  </div>
              ...
              <div class="accordion-item rounded-3 my-3">
                <h2 class="accordion-header" id="flush-headingTwo">
                  <button class="accordion-button collapsed  text-primary fw-bold h4" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">Questions Related to Used Tractor Loan</button>
                </h2>
                    ...
                    <ul>
                        <li>
                          <b>Que. Who is eligible for a used tractor loan?</b>
                           <p>Ans. Individuals with a satisfactory credit history are eligible for a used tractor loan.</p>
                         </li>

                        <li><b>Que. How much can I borrow for a used tractor loan?</b>
                     <p>Ans. You can borrow up to 90% of the tractor's price with a used tractor loan.
                     </p>
                    </li>

                     <li>
                     <b>Que. Is there an early repayment option for a used tractor loan?</b>
                     <p>Ans. Repayment and closure are allowed after 6 months with some charges as mentioned in the loan agreement.</p>
                    </li>
                   <li>
            ...
            <p>Ans. Approval for a used tractor loan is immediate after the application is submitted.</p>
            <li>
            </ul>
                    </p>
                  </div>
              ...
              <div class="accordion-item  rounded-3 my-3">
                <h2 class="accordion-header" id="flush-headingThree">
                  <button class="accordion-button collapsed text-primary fw-bold h4" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">Questions Related to Implement Loan</button>
                </h2>
                <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">
                    ...
                    <ul>
                        <li>
                          <b>Que. Who is eligible for an implement loan?</b>
                           <p>Ans. Individuals aged 18 to 65 years with a satisfactory credit history can apply for an implement loan.</p>
                         </li>
                   ...
                   <b>Que. Is there a specific repayment period for implement loans?</b>
                    <p>Ans. The repayment period for implement loans is typically 60 months (5 years).</p>
                  </li>

                 <li>
               <b>Que. Can I get an implement loan without submitting collateral?</b>
               <p>
                Ans. Yes, implement loans can be availed with or without submitting collateral, providing flexibility to applicants.</p>
              <li>
               </ul>
                    </p>
                  </div>
              ...
              <div class="accordion-item  rounded-3 my-3">
                <h2 class="accordion-header" id="flush-heading4">
                  <button class="accordion-button collapsed text-primary fw-bold h4" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse4" aria-expanded="false" aria-controls="flush-collapse4">Questions Related to Loan Against Tractor </button>
                </h2>
                <div id="flush-collapse4" class="accordion-collapse collapse" aria-labelledby="flush-heading4" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">
                    <p class="text-dark">
                     ...
                     <li>
                     <b>Que. What is the minimum ownership period required for a loan against tractor?</b>
                     <p>Ans. To be eligible, the owner must have paid at least 12 EMIs of the current loan.</p>
                    </li>
                   <li>
                   <b>Que. What documents are needed for a loan against tractor?</b>
                    <p>Ans. Required documents include proof of ownership (RC), bank account statement, KYC documents, and PAN card.</p>
                  </li>

                 <li>
               <b>Que. Is there a specific waiting period for repayment and closure?</b>
               <p>Ans. Repayment and closure are not allowed for the first 6 months. After that, it can be done with charges mentioned in the loan agreement.</p>
              <li>
               </ul> 
                    </p>
                  </div>
            ...
            <div class="accordion-item  rounded-3 my-3"> 
                <h2 class="accordion-header" id="flush-heading5">
                  <button class="accordion-button collapsed text-primary fw-bold h4" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse5" aria-expanded="false" aria-controls="flush-collapse5">Questions Related to Personal Loan</button>
                </h2>
                <div id="flush-collapse5" class="accordion-collapse collapse" aria-labelledby="flush-heading5" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">
                    ...
                    <ul>
                     ...
                     <p>Ans. Required documents include a photo, identity proof, address proof, income proof, and a 3-month bank statement.
                     </p>
                    </li>
