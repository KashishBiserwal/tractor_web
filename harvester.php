...
<html lang="en">
    ...
    <script src="<?php $baseUrl; ?>model/harvester_customer.js" defer></script>
    <!-- Google tag (gtag.js) -->
                ...
                <div class="col-12 col-sm-3 col-lg-3 col-md-3">
                    ...
                    <div class="mb-3" id="">
                        <div class="force-overflow">
                            ...
                            <div class="price pt-4 w-100"  id="POWER_SOURCE"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="conntainer text-center">
            ...
            <div class="py-3 container">
                <p class="text-dark" style="text-align: justify;"> 
                    This Platform brings to you the options to choose the best Tractor Combine Harvesters for your farming needs. 
                    Best-in-Class machines with up-to-date technologies and high reliability brand support all through one site, BharatAgrimart's. 
                    We at BharatAgrimart's, know how crucial it can be for you to choose amongst the varied options amongst Tractor Combine 
                    Harvester and therefore we bring to you the best options along with reasonable price listing and description about all the specifications. 
                    The choice might be yours but you are never alone to make this choice, we make sure about this.
                </p>
                <p class="py-2" style="text-align: justify;">
                    Choose amongst various brands such as Hind Agro, Dashmesh, Claas, New Hind, Preet, etc. 
                    Also you can select according to the needed Cutting Width. Not only this you can also filter your 
                    search on the basis of the Power Source, be it Self Propelled or Tractor Mounted, but we also have it all. 
                    BharatAgrimart's is committed to bringing to you the best products from the finest houses so you don’t have to mess with service providers thereafter. 
                    We bring to you the best because we know the value of the best. BharatAgrimart's serving you 24*7 at your finger clicks.
                </p>
            </div>
        </div>
    </section>
