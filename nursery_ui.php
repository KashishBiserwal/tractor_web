        ...
        <div class="container mt-4">
            <div class="row">
                                    ...
                                    <div class="power text-center mt-3">
                                        <div class="row ">
                                            <div class="col-12 col-lg-6 col-md-6 col-sm-6">
                                                <p class="text-success ps-2"> <i class="fa fa-leaf"
                                                        aria-hidden="true"></i> Flower</p>
                                            </div>
                                            <div class="col-12 col-lg-6 col-md-6 col-sm-6" style="padding-right: 32px;">
                                                <a href="nursery_inner.php" id="adduser" type=""
                                                    class="text-danger fw-bold text-decoration-none"> Merigold</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="content d-flex flex-column flex-grow-1 ">
                                    <div class="power text-center mt-3">
                                        <div class="row ">
                                            <div class="col-12 col-lg-6 col-md-6 col-sm-6">
                                                <p class="text-success ps-2"> <i class="fa fa-leaf"
                                                        aria-hidden="true"></i> plant</p>
                                            </div>
                                            <a href="#" class="col-12 col-lg-6 col-md-6 col-sm-6 text-decoration-none"
                                ...
                                <div class="content d-flex flex-column flex-grow-1 ">
                                    <div class="power text-center mt-3">
                                        <div class="row ">
                                            <div class="col-12 col-lg-6 col-md-6 col-sm-6">
                                                <p class="text-success ps-2"> <i class="fa fa-leaf"
                                                        aria-hidden="true"></i> child plant</p>
                                            </div>
                                            <div class="col-12 col-lg-6 col-md-6 col-sm-6" style="padding-right: 32px;">
                ...
                <div class="col-12 col-sm-3 col-lg-3 col-md-3">
                    ...
                    <div class=" mb-3 pt-2" id="">
                        <div class="force-overflow">
                            <div class="price py-2 ">
                                <h5 class=" ps-3 text-dark fw-bold mb-3">Search By State</h5>
                                <input type="checkbox" class="checkbox-round ms-3" value="cg" /><span class="ps-2 fs-6">
                                    Chhattisgarh</span><br />
                                <input type="checkbox" class="checkbox-round ms-3" value="other" /><span
                    ...
                    <div class="scrollbar mb-3" id="">
                        <div class="force-overflow">
                            ...
                            <div class="HP py-2">
                                <input type="checkbox" class="checkbox-round ms-3" value="raipur" /><span
                                    class="ps-2 fs-6">Raipur</span><br />
                                <input type="checkbox" class="checkbox-round ms-3" value="Bilaspur" /><span
                                    class="ps-2 fs-6">Bilaspur</span><br />
                                <input type="checkbox" class="checkbox-round ms-3" value="Ambikapur" /><span
                                    class="ps-2 fs-6">Ambikapur</span><br />
                                <input type="checkbox" class="checkbox-round ms-3" value="Raigarh" /><span
                                    class="ps-2 fs-6">Raigarh</span><br />
                                <input type="checkbox" class="checkbox-round ms-3" value="Surajpur" /><span
                                    class="ps-2 fs-6">Surajpur</span><br />
                                <input type="checkbox" class="checkbox-round ms-3" value="Chirmiri" /><span
                                    class="ps-2 fs-6">Chirmiri</span><br />
                                <input type="checkbox" class="checkbox-round ms-3" value="Korba" /><span
                    ...
                    <div class="scrollbar mb-3" id="">
                        <div class="force-overflow">
                            <h5 class=" ps-1 text-dark fw-bold pt-2">Search By Tehsil</h5>
                            <div class="HP py-2">
                                <input type="checkbox" class="checkbox-round ms-3" value="raipur" /><span
                                    class="ps-2 fs-6">Raipur</span><br />
                                <input type="checkbox" class="checkbox-round ms-3" value="Bilaspur" /><span
                    ...
                    <div class=" mb-3" id="">
                        <div class="force-overflow">
                            ...
                            <div class="price py-2 ">
                                <input type="checkbox" class="checkbox-round ms-3" value="less_30day" /><span
                                    class="ps-2 fs-6">Less than 30 days</span><br />
                                <input type="checkbox" class="checkbox-round ms-3" value="less_30mnth" /><span
                                    class="ps-2 fs-6">Less than 3 months</span><br />
                                <input type="checkbox" class="checkbox-round ms-3" value="less_60_mnth" /><span
