    ...
    <section class="mt-5 pt-5 mb-5">
        <div class="container mt-5 pt-5 mb-5 bg-light">
            <div class="row shadow" style=" width: 80%; justify-content: center;  margin: 0 auto;">
                <form id="multistep-form" class="my-form">
                    ...
                    <fieldset class="field-set mt-4 pt-4 " id="step1">
                        ...
                        <button type="button" name="next-step"
                            class="next-step  btn btn-dark float-end mt-4 ">Next</button>
                    </fieldset>
                    ...
                    <fieldset class="field-set  mt-4 pt-4" id="step2">
                        ...
                        <button type="button" name="next-step"
                            class="next-step  float-end btn btn-dark mt-4 ">Next</button>
                        <button type="button" name="previous-step"
                            class="previous-step btn btn-danger mt-4 float-end mx-2">Previous</button>
                    </fieldset>
...
//     // Implement logic to fetch and populate subcategories based on the selected category
//     // For now, let's assume static values for demonstration
//     var subcategories = {
//         1: ["Potato", "Tomato", "Carrot"],
//         2: ["Apple", "Banana", "Orange"],
//         3: ["Rice", "Wheat", "Barley"],
//         4: ["Lentils", "Chickpeas", "Black Beans"]
//     };
//     populateDropdown($("#subcategory"), subcategories[selectedCategory]);
// });
...
//     // For now, let's assume static values for demonstration
//     var districts = {
//         1: ["District A", "District B", "District C", "District X", "District Y", "District Z",
//             "District P", "District Q", "District R"
//         ]
//     };
//     populateDropdown($("#district"), districts[selectedState]);

//     // Clear tehsil dropdown when changing the state
//     $("#tehsil").empty().append("<option value='' selected disabled>Select Tehsil</option>");
// });

// // Populate tehsils based on the selected district
// $("#district").change(function() {
//     var selectedDistrict = $(this).val();
//     // Implement logic to fetch and populate tehsils based on the selected district
//     // For now, let's assume static values for demonstration
//     var tehsils = {
//         "District A": ["Tehsil 1A", "Tehsil 2A", "Tehsil 3A"],
//         "District B": ["Tehsil 1B", "Tehsil 2B", "Tehsil 3B"],
//         "District C": ["Tehsil 1C", "Tehsil 2C", "Tehsil 3C"],
//         "District X": ["Tehsil 1X", "Tehsil 2X", "Tehsil 3X"],
//         "District Y": ["Tehsil 1Y", "Tehsil 2Y", "Tehsil 3Y"],
//         "District Z": ["Tehsil 1Z", "Tehsil 2Z", "Tehsil 3Z"],
//         "District P": ["Tehsil 1P", "Tehsil 2P", "Tehsil 3P"],
//         "District Q": ["Tehsil 1Q", "Tehsil 2Q", "Tehsil 3Q"],
//         "District R": ["Tehsil 1R", "Tehsil 2R", "Tehsil 3R"]
//     };
//     populateDropdown($("#tehsil"), tehsils[selectedDistrict]);
// });
...
//         // Reset to the first step after clicking "OK" on the Success Page
//         $("#multistep-form")[0].reset(); // reset the form
//         currentStep = 0;
//         showStep(currentStep);
//     });
...
//         $("#progress_bar li").removeClass("active");
//         $("#progress_bar li:lt(" + (step + 1) + ")").addClass("active");
//     }
