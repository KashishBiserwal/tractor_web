...
<head>
    ...
    <script src="<?php echo $baseUrl; ?>model/new_tractor_inner.js" defer></script>
...
<body>
            ...
            <div class="py-2">
                <span class="text-white">
                    <a href="index.php" class="text-decoration-none header-link px-1">
                        Home <i class="fa-solid fa-chevron-right px-1"></i>
                    </a>
                    <a href="" id="model_name" class="text-decoration-none header-link px-1">
                    ...
                    <table class="table border bg-light">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h5>
                                        <a href="mahindra.php" class="text-decoration-none h5 text-danger" id="brand_name"></a>
                                    </h5>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><span id="hp_category"></span> HP</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><span id="warranty"></span> Year</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <h6>
                                        <a href="#" class="text-decoration-none text-success">Check Price</a>
                                    </h6>
                                </td>
                            </tr>
                        </tbody>
        ...
        <div class="container ">
            <div class="row  pt-4">
                ...
                <div class="col-12 col-lg-4 col-md-4 col-sm-4">
                    ...
                    <div class="row" id="related_brand"></div>
                    <div class=" text-center">
                        <button class=" btn btn-success w-75 mt-2 mx-auto" id="loadMoreButton">Load More</button>
                    </div>
                    <div class="sticky my-3">
                        ...
                        <div class="popular-used-tractor">
                            <div class="row" id="productContainerpopular"></div>
                            <div class=" text-center">
                                <button class="btn btn-success" id="loadMoretract">Load More</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="about border-success  border-4 text-dark border-start">
                <h4 class="text-dark fw-bold text-start ps-2">
                    <span class="brand_model text-success"></span> Dimensions And Weight Of Tractor
                </h4>
            </div>
            <div class="row">
                <div class="col-12 col-lg-8 col-md-8 col-sm-8">
    ...
    <section class="mt-3">
        <div class="container">
            <div class="about border-success  border-4 text-dark border-start">
                <h4 class="text-dark fw-bold text-start ps-2">
                    <span class=" text-success brand_model"></span> Other Information</span>
                </h4>
            </div>
            <div class="row">
                <div class="col-12 col-lg-8 col-md-8 col-sm-8">
                    ...
                    <div class="accordion-item  rounded-3">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <p class="text-dark">Ans. Mahindra 575 DI XP Plus Tractor comes with 47 HP 
                                    for long-term farming tasks.
                                </p>
                            </div>
                        </div>
                    </div>
