                        ...
                        <div class="h-auto success__stry__item d-flex flex-column shadow ">
                            ...
                            <div class="content d-flex flex-column flex-grow-1 ">
                                ...
                                <div class="power text-center mt-2">
                                    <div class="row ">
                                        <div class="col-12 col-lg-6 col-md-6 col-sm-6"><p class="text-dark ps-2"><i class="fas fa-bolt"></i> 57 HP</p></div>
                                        <div class="col-12 col-lg-6 col-md-6 col-sm-6" style="padding-right: 32px;">
                                             <p id="adduser" type="" class="text-dark">
                                              <i class="fa-solid fa-gear"></i>  3531 CC </p>
                                        </div>
                                    </div>    
                                </div>
                                <div class="col-12">
                    ...
                    <div class="col-12 col-lg-4 col-md-4 col-sm-4 mb-3">
                        <div class="h-auto success__stry__item d-flex flex-column shadow ">
                            ...
                            <div class="content d-flex flex-column flex-grow-1 ">
                                <div class="caption text-center">
                                    <a href="#" class="text-decoration-none text-dark">
                                        <p class="pt-3"><strong class="series_tractor_strong text-center h4 fw-bold ">Mahindra Oja 3140 4WD</strong></p>
                                    </a>      
                                </div>
                                <div class="power text-center mt-2">
                                    <div class="row ">
                    ...
                    <div class="col-12 col-lg-4 col-md-4 col-sm-4 mb-3">
                        <div class="h-auto success__stry__item d-flex flex-column shadow ">
                            <div class="thumb">
                                <a href="#">
                                    <div class="ratio ratio-16x9">
                                        <img src="assets/images/farmtrac-60-powermaxx-1690541201.webp" class="object-fit-cover " alt="img">
                                    </div>
                                </a>
                            </div>
                            <div class="content d-flex flex-column flex-grow-1 ">
                                <div class="caption text-center">
                                    <a href="#" class="text-decoration-none text-dark">
                                        <p class="pt-3"><strong class="series_tractor_strong text-center h4 fw-bold ">Farmtrac 60 PowerMaxx</strong></p>
                                    </a>      
                                </div>
                                <div class="power text-center mt-2">
                                    <div class="row ">
                ...
                <div class=" mb-3" id="">
                    <div class="force-overflow">
                        <div class="price py-2 ">
                            ...
                            <input type="checkbox" class="checkbox-round ms-3" value="3-6"/><span class="ps-2 fs-6"> 3 Lakh - 5 Lakh</span><br />
                ...
                <div class="scrollbar mb-3" id="">
                    ...
                    <h5 class=" ps-1 text-dark fw-bold pt-2">Search By HP</h5>
                        <div class="HP py-2">
                            ...
                            <input type="checkbox" class="checkbox-round ms-3" value="61-70"/><span class="ps-2 fs-6">61 HP - 75 HP</span><br />
                            <input type="checkbox" class="checkbox-round ms-3" value="71-80"/><span class="ps-2 fs-6">Above 75 Hp </span><br />
                        </div>
                    </div>
                </div>
