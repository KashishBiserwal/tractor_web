              ...
              <table id="example" class="table  table_useroverview dataTable no-footer py-1" width="100%">
                <thead>
                  <tr>
                    ...
                    <th class="d-none d-md-table-cell text-dark">Model Name </th>
                    <th class="d-none d-md-table-cell text-dark">Date</th>
                    <th class="d-none d-md-table-cell text-dark">Power</th>
                    <th class="d-none d-md-table-cell text-dark">Cutter bar</th>
                    <th class="d-none d-md-table-cell text-dark">No. of Cylinder</th>
                    <th class="d-none d-md-table-cell text-dark">Power Source</th>
