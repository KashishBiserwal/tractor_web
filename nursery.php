                                ...
                                <div class="row justify-content-center pt-4">
                                        ...
                                        <div class="col-12  ">
                                          <div class="form-outline mt-3">
                                            ...
                                            <textarea rows="3" cols="70" class="w-100 py-2" minlength="0" maxlength="1000" id="textarea_d" name="textarea_d"></textarea>
                                          </div>
                                        </div>
                            ...
                            <form id="narsary_list_form"method="post"enctype="multipart/form-data" onsubmit="return false">
                                ...
                                <div class="col-12 col-lg-6 col-sm-5 col-md-6 my-1" hidden>
                                        ...
                                        <div class="col-12  ">
                                          <div class="form-outline mt-3">
                                            <label class="form-label text-dark">Description</label>
                                            <textarea rows="3" cols="70" class="w-100 py-1" minlength="0" maxlength="1000" id="textarea_d2" name="textarea_d2"></textarea>
                                          </div>
                                        </div>
                                        <div class="col-12 col-lg-6 col-md-6 col-sm-6 mt-5">
                                          <div class="upload__box mt-3">
