...
include 'includes/headertag.php';
  ...
  <script src="<?php $baseUrl; ?>model/farm_implement_category.js"></script>
<body class="loaded"> 
    ...
    <div class="">
      ...
      <div class="card-body d-flex align-items-center justify-content-between page_title">
          ...
          <button type="button" id="add_trac" class="btn add_btn btn-success float-right btn_all" data-bs-toggle="modal"  data-bs-target="#staticBackdrop1">
              <i class="fa fa-plus" aria-hidden="true"></i> Add Implement Category
          </button>
                              ...
                              <div class="row justify-content-center">
                                <div class="col-12 mt-4">
                                  <div class="form-outline">
                                    <label class="form-label text-dark">Implement Category Name<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control " for="name" name="name" placeholder="" id="name">
                                  </div>
                                </div>
                                <!-- <div class="col-12 col-sm-12 col-md-2 col-lg-2 pe-3">
            ...
            <form action="" id="myform" class="mb-0">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="form-outline">
                            <label class="form-label">Search by Field</label>
        ...
        <table id="example" class="table table-striped table-hover table-bordered no-footer" width="100%;">
            <thead>
                    <tr>
                        ...
                        <th class="d-none d-md-table-cell text-white">Category Type </th>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content modal_box">
                  ...
                  <form id="look_up_form1" method="POST">
                    <div class="row justify-content-center">
                      <div class="col- col-sm-6 col-lg-6 col-md-6" hidden>
                        ...
                        <input type="text" class="form-control py-2" for="idUser"  id="idUser" name="first_name">
                        <small></small>
                      </div> 
                      ...
                      <div class="col-12 mt-4">
                        <div class="form-outline">
                          ...
                          <input type="text" class="form-control " for="name" name="name11" id="look_up_name" placeholder="">
                        </div>
                      </div>
                        <!-- <div class="col-12 col-sm-12 col-md-2 col-lg-2 pe-3">
                            <div class="background__box">
                                <div class="background__btn-box ">
                                    <label class="background__btn">
                                    <p>Upload images</p>
                                    <input type="file" data-max_length="20"name="imgfile1"   type="file"
                                    id="image1"ref="fileInput"style="display: none"@change="handleFileInput"
                                    accept="image/png, image/jpg, image/jpeg" class="background__inputfile" >
                                    </label>
                                </div>
                                <div class="">
            ...
            <div class="modal-footer">
              ...
              <button type="button" id="savechangebtn" data-bs-dismiss="modal" class="btn btn-success fw-bold px-3">Save Change</button>
            </div>
          </div>
        </div>
      </div>
