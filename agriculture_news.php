...
<section class="mt-4 pt-5">
    <div class="container mt-5 pt-4">
        <div class="">
            ...
            <span class="text-dark"> Agriculture News</span>
            </span> 
        </div>
    </div>
</section>
            ...
            <!-- <div class="col-12 col-lg-4 col-sm-4 col-md-4 mt-2 mb-2">
                <div class="success__stry__item shadow h-100">
                    ...
                    <div class="content mb-3 ms-3">
                        <button type="button" class="btn btn-warning">Agriculture News</button>
                        <div class="row mt-2">
