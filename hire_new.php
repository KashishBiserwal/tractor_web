...
<head>
    ...
    <script src="<?php $baseUrl; ?>model/hire_customer_new.js" defer></script>
...
">
            ...
            <div class="row" style="margin-left: auto;">
                ...
                <div class="col-12 col-sm-9 col-lg-7 col-md-7">
                    <h3 class="d-flex justify-content-center gap-2 pb-3"><span class="fw-bold"
        ...
        <div class="container">
            ...
            <div class="row my-4">
                <div class="col-12 col-lg-4 col-md-4 col-sm-4 py-2">
                    <a href="tractor_by_budget.php?budget=3 Lakh Below" id="adduser"
