...
<html lang="en">
   ...
   <body>
            ...
            <div class="pt-5">
               <span class="mt-4 pt-4 ">
                  <a href="index.php" class="text-decoration-none header-link px-1">Home <i class="fa-solid fa-chevron-right px-1"></i></a>
                     <span class=""><span class=" header-link  px-1">Enquiry<i class="fa-solid fa-chevron-right px-1"></i> </span></span>
      ...
      <section class="bg-light">
         <div class="container ">
         <h3 class="my-5 pt-4 display-6 fw-bold">Tractors in <span class="text-success">2023</span></h3>
            <nav class="">
