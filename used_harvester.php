        ...
        <div class="row">
            <div class="col-12 col-sm-9 col-lg-9 col-md-9">
                ...
                <div class="text-center my-2">
                    <button type="submit" id="loadMoreBtn" style="background: #B90405; color: #fff;" class="btn  shadow px-5 w-40">Load More</button>         
                </div> 
            </div>
            <div class="col-12 col-sm-3 col-lg-3 col-md-3">
                    ...
                    <div class="col-12 ">
                        <div class=" row text-center">
                            <div class="col-6 col-sm-6 p-2">
                                <button id="reset_tractor" type="button" onclick="resetform()" style="background: #B90405; color: #fff;" class=" btn  w-100">
                                <i class="fas fa-undo"></i>  Reset </button>
                            </div>
                            <div class="col-6 col-sm-6 p-2">
                                <button id="filter_tractor" type="button" style="background: #B90405; color: #fff;" class=" btn  w-100">
                ...
                <div class="scrollbar mb-3" id=" my-2">
                    <div class="force-overflow">
                        ...
                        <div class="HP py-2 w-100" id="state_state" style=" height: 78px;"></div>
                    </div>
                </div>
                <div class="scrollbar mb-3" id=" my-2">
                    <div class="force-overflow">
                        <h5 class=" ps-1 text-dark fw-bold  pt-2">Search By District</h5>
                        <div class="HP py-2 w-100" id="district_dist"></div>
                    </div>
                </div>
                <div class="scrollbar mb-3" id="my-2">
                    <div class="force-overflow">
