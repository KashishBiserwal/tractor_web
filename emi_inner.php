...
<script> var baseUrl = "<?php echo $baseUrl; ?>";</script>
    ...
    <script src="<?php $baseUrl; ?>model/emi_inner.js" defer></script>
    <style>
        .invalid-feedback {
            display: block;
        }
                ...
                <div class="card bg-light">
                    <div class="card-body">
                        ...
                        <a href="javascript:void(0)"
                            ...
                            data-toggle="collapse" data-target="#collapse1">Read More
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-sm-6 col-lg-6">
                    ...
                    <button type="button" class="w-100 btn btn-outline-success fw-bold mt-3 mb-2" data-bs-toggle="modal"
                        data-bs-target="#staticBackdrop">Get on road Price
                    </button>
                    <!-- Modal -->
    ...
    <section>
        <div class="container shadow mt-5 mb-3">
            <div class="row">
                ...
                <!-- Bank Interest Rate -->
                <div class=" col-12 col-lg-6 col-md-6 col-sm-6 py-2 mt-2 mb-1">
                    <label for="interestRate" class="form-label fw-bold text-dark h5 ">Bank Interest Rate (%)</label>
                ...
                <!-- Repayment Interval -->
                <div class="col-12 col-lg-6 col-md-6 col-sm-6 py-2 mt-2 mb-1">
                    <label for="repaymentInterval" class="form-label fw-bold text-dark h5">Repayment Interval</label>
