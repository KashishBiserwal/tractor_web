                        ...
                        <div class="success__stry__item shadow h-100">
                            <div class="thumb">
                                <a href="news_content.php?id=${p.id}">
                                    <img src="http://tractor-api.divyaltech.com/uploads/news_img/${a[0]}" class="agriculture_img  w-100" alt="img">
                                </a>
                            </div>
                            <div class="content mb-3 ms-3">
                                <button type="button" class="btn btn-warning">${p.news_category}</button>
                                <div class="row mt-2">
                                    <p class="fw-blod">${p.news_headline}</p>
                                </div>
                                <a href="news_content.php?id=${p.id}" class="text-decoration-none text-dark pb-1">
                                <span class=""> Date/time-${p.date} </span>  <span class=""> 23-November-2023 </span>
                                </a>
                            </div>
                        </div>
                    </div> 
