$(document).ready(function () {
  ...
  function college_details_list(allCards) {
    var url =
      "https://shopninja.in/bharatagri/api/public/api/customer/agriculture_data";
    $.ajax({
      url: url,
      type: "GET",
      success: function (data) {
        ...
        if (data.colleges_data && data.colleges_data.length > 0) {
          ...
          displayagriculturecollege(
            productContainer,
            reversedCards.slice(0, 6).reverse()
          );
          loadMoreButton.show();
    ...
    nursery.forEach(function (p) {
      ...
      var newCard = `
                <div class="col-12 col-lg-4 col-md-4 col-sm-4 mb-4" id="${cardId}">
                    ...
                    <div class="col-12 " style="background-color: #B90405;">
                        <button type="button" id="modelbutton" style="background-color: #B90405; color: #fff;" class="w-100" data-bs-toggle="modal" data-bs-target="#${modalId}" onclick="populateDropdowns('${modalId}'); getUserDetail(${userId}, '${formId}')">
                             Contact Now
                        </button>
                    </div>
                    ...
                    <div class="modal fade" id="${modalId}" data-bs-backdrop="static"
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            ...
                            <button type="button" class="btn-close " data-bs-dismiss="modal" aria-label="Close"><img src="assets/images/close.png"></button>
                          </div>
                                    ...
                                    <div class="model-cont">
                                        <form id="${formId}" method="POST" onsubmit="return false">
                                            <div class="row">
                                                ...
                                                <button type="submit" id="submit_enquiry" style=" background-color: #B90405; color: #fff;" class="btn  w-100 btn_all" onclick="savedata('${formId}')" data-bs-dismiss="modal">Submit</button>
                ...
                <div class="modal fade" id="get_OTP_btn" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn " id="Verify" onclick="verifyotp('${formId}')" style=" background-color: #B90405; color: #fff;">Verify</button>
                            </div>
                        </div>
                    </div>
                </div> `;
      ...
      if (response.customerData && response.customerData.length > 0) {
        ...
        if (isUserLoggedIn()) {
          $("#" + formId + " input, #" + formId + " select")
            .not("#price,#district_1,#state_1,#Tehsil_1")
            .prop("disabled", true);
        }
      }
    },
...
function filter_search() {
  ...
  var selectedCheckboxValues = select_state
    .map(function () {
      return $(this).val();
    })
    .get();

  var selectedCheckboxValues2 = select_district
    .map(function () {
      return $(this).val();
    })
    .get();
  ...
  var url =
    "https://shopninja.in/bharatagri/api/public/api/customer/agriculture_filter";
  $.ajax({
    url: url,
    type: "POST",
    data: paraArr,
                                ...
                                <div class="model-cont">
                                    <form id="${formId}" method="POST" onsubmit="return false">
                                        <div class="row">
                                            ...
                                            <div class="modal-footer">
                                            <button type="submit" id="submit_enquiry" class="btn   w-100 btn_all" onclick="savedata('${formId}')" data-bs-dismiss="modal" style=" background-color: #B90405; color: #fff;">Submit</button>
                                            <!-- <a class="btn  text-primary" data-dismiss="modal">Ok</a> -->
                                        </div>
                                        </div>
                                    </form>
    ...
    success: function (data) {
      ...
      if (data && data.districtData && data.districtData.length > 0) {
        ...
        checkboxContainer.append(
          `<p>No districts available for state ID: ${stateId}</p>`
        );
      }
    },
    error: function (error) {
