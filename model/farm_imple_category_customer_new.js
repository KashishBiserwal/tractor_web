    ...
    <div class="text-center pt-2">
        ...
        <div class="row justify-content-center mb-2">
            <div class="col-lg-6 col-sm-6 col-md-6">
                <p class="fw-bold text-center py-2" style="background-color: #E9F5FF; border-radius: 30px;">${p.category_name}</p>
            </div>
            <div class="col-lg-6 col-sm-6 col-md-6">
                <p class="fw-bold text-center py-2" id="subcategory"style="background-color: #E9F5FF; border-radius: 30px;">${spacedString}</p>
            </div>
        </div>
        <a href="detail_implement.php?id=${p.product_id}" class="text-decoration-none">
            <div style="background-color: #B90405; border-radius: 10px; padding-bottom: 5px;"><p class="text-white text-decoration-none pt-2">View Details</p></div>
        </a>
    </div>
</div>
</div>
