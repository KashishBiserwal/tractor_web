function getpopularTractorList(){$.ajax({url:"http://tractor-api.divyaltech.com/api/customer/get_new_tractor",type:"GET",success:function(t){let r=[];t.product.accessory_and_tractor_type.filter(t=>{if(t.tractor_type_name.split(",").includes("Popular"))return r.push(t.product_id),t.product_id});var o=$("#popular_tractor");t.product.allProductData&&0<t.product.allProductData.length&&t.product.allProductData.forEach(function(t){var e,a;r.includes(t.product_id)&&(e=[],(a=t.image_names)&&(e=-1<a.indexOf(",")?a.split(","):[a]),a=`<div class="swiper-slide success__stry__item  box_shadow  b-t-1 h-100">
   ...
   </div>`,o.append(a))})},error:function(t){console.error("Error fetching data:",t)}})}function getminiTractorList(){$.ajax({url:"http://tractor-api.divyaltech.com/api/customer/get_new_tractor",type:"GET",success:function(t){let r=[];t.product.accessory_and_tractor_type.filter(t=>{if(t.tractor_type_name.split(",").includes("Mini"))return r.push(t.product_id),t.product_id});var o=$("#mini_tractor");t.product.allProductData&&0<t.product.allProductData.length&&t.product.allProductData.forEach(function(t){var e,a;r.includes(t.product_id)&&(e=[],(a=t.image_names)&&(e=-1<a.indexOf(",")?a.split(","):[a]),a=` <div class="swiper-slide success__stry__item  box_shadow  b-t-1 h-100">
    <a   class="text-decoration-none" href="detail_tractor.php?product_id=${t.product_id}">
        <div class="thumb">
            <img src="http://tractor-api.divyaltech.com/uploads/product_img/${e[0]}" class="" alt="img" loading="lazy">
        </div>
...
</div>`,o.append(a))})},error:function(t){console.error("Error fetching data:",t)}})}function getLatestTractorList(){$.ajax({url:"http://tractor-api.divyaltech.com/api/customer/get_new_tractor",type:"GET",success:function(t){let r=[];t.product.accessory_and_tractor_type.filter(t=>{if(t.tractor_type_name.split(",").includes("Latest"))return r.push(t.product_id),t.product_id});var o=$("#Latest_tractor");t.product.allProductData&&0<t.product.allProductData.length&&t.product.allProductData.forEach(function(t){var e,a;r.includes(t.product_id)&&(e=[],(a=t.image_names)&&(e=-1<a.indexOf(",")?a.split(","):[a]),a=`  <div class="swiper-slide success__stry__item  box_shadow  b-t-1 h-100">
                            <a  class="text-decoration-none " href="detail_tractor.php?product_id=${t.product_id}">
                            <div class="thumb">
                                   <img src="http://tractor-api.divyaltech.com/uploads/product_img/${e[0]}" class="" alt="img" loading="lazy">
                             </div>
...
`);r.append(e)}),r.owlCarousel({items:4,loop:!0,margin:10,nav:!0,autoplay:!0,autoplayTimeout:3e3,responsiveClass:!0,responsive:{0:{items:1,nav:!1},600:{items:3,nav:!1},1e3:{items:4,nav:!0,loop:!1}}}))},error:function(t){console.error("Error fetching data:",t)}})}function get_All_News(){$.ajax({url:"http://tractor-api.divyaltech.com/api/customer/news_details",type:"GET",success:function(t){var r;t.news_details&&0<t.news_details.length&&(r=$("#all_news"),t.news_details.forEach(function(t){var e=t.image_names,a=[],e=(e&&(a=-1<e.indexOf(",")?e.split(","):[e]),`
...
`);r.append(e)}),r.owlCarousel({items:4,loop:!0,margin:10,nav:!0,autoplay:!0,autoplayTimeout:3e3,responsiveClass:!0,responsive:{0:{items:1,nav:!1},600:{items:3,nav:!1},1e3:{items:4,nav:!0,loop:!1}}}))},error:function(t){console.error("Error fetching data:",t)}})}function get_blog(){$.ajax({url:"http://tractor-api.divyaltech.com/api/customer/blog_details",type:"GET",success:function(t){var r;t.blog_details&&0<t.blog_details.length&&(r=$("#blog"),t.blog_details.forEach(function(t){var e=t.image_names,a=[],e=(e&&(a=-1<e.indexOf(",")?e.split(","):[e]),`
