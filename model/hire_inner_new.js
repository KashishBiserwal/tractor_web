...
function getHireTracById() {
    ...
    var url = 'https://shopninja.in/bharatagri/api/public/api/customer/get_rent_data_by_id/' + Id;
        ...
        success: function(data) {
            ...
            data.rent_details.data2.forEach(function(item) {
                ...
                imageNames.forEach(function(imageName) {
                    var imageUrl = "https://shopninja.in/bharatagri/api/public/uploads/rent_img/" + imageName.trim();
                    ...
                    var tableCol = $(` 
                        <div class="col-6">
                            ...
                            <div class="col-12">
                                <button id="send_enquiry" type="button" style="background-color: #B90405; color: white; border-radius: 10px; margin-top: 10px" class="add_btn w-100" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                    Send Enquiry</button>
                            </div>
                        </div>
                    `);
