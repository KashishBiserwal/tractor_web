...
function gethaatbazzat() {
  ...
  $.ajax({    
      ...
      success: function(data) {
          ...
          document.getElementById('category_main').innerText = data.allData.haat_bazar_data[0].category_name; 
          document.getElementById('district_main').innerText = data.allData.haat_bazar_data[0].district; 
