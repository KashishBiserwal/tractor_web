        ...
        <div class="vegehead pt-3">
          <div class="row">
            <div class="col-12 col-lg-6 ">
              <h1 class="fw-bold text-danger pt-3">Nursury in District Name</h1>
            </div>
    ...
    <section>
      <div class="container">
        ...
        <table class="table w-75 table-hover table table-striped my-4">
            <tbody>
                <tr>
                <td class="table-data">Nursery Location</td>
                <td class="table-data">	fjjfnvjfkdbv</td>
                </tr>
                <tr>
                            ...
                            <div class="thumb">
                                <div>
                                    <div class="ratio ratio-16x9">
                                        <img src="assets/images/default-plant-nurseries-9.avif" class="object-fit-cover w-100 " alt="img">
                                    </div>
                                </div>
                            </div>
                            <div class="content d-flex flex-column flex-grow-1 ">
                    ...
                    <div class="col-12 col-lg-3 col-md-3 col-sm-3 mb-4">
                        <a href="#" class="h-auto success__stry__item text-decoration-none d-flex flex-column shadow ">
                            <div class="thumb">
                                <div>
                                    <div class="ratio ratio-16x9">
                                        <img src="assets/images/seeds-child-plant-nature-macro-nursery.jpg" class="object-fit-cover " alt="img">
                                    </div>
                                </div>
                            </div>
                            <div class="content d-flex flex-column flex-grow-1 ">
